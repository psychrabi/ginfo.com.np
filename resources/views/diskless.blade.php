...
<body>
        ...
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-between">
                <div class="">
                    ...
                    <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#download-form">Get a free trial today</button>
                </div>
    ...
    <!-- Modal -->
<div class="modal fade" id="download-form" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
